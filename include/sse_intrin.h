...
#include "../simde-0.7.2/simde/x86/avx2.h"
#endif

#ifndef SSE_INTRIN_H
#define SSE_INTRIN_H

#if defined(__x86_64) || defined(__i386__) || defined(__x86_64__) || defined(SIMDE_ENABLE_NATIVE_ALIASES)
#ifndef SIMDE_ENABLE_NATIVE_ALIASES
// #ifndef __SSE2__
 ...
 * \copyright Apache License 2.0
 */
static inline __m128i ssp_logical_bitwise_select_SSE2(__m128i a, __m128i b, __m128i mask)
{                                // Bitwise (mask ? a : b)
